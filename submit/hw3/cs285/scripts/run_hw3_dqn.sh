...
python cs285/scripts/read_results.py q2_dqn_1 q2_dqn_2 q2_dqn_3 --plot_type avg_performance --figname image/exp2_1.png
...
python cs285/scripts/read_results.py q2_doubledqn_1 q2_doubledqn_2 q2_doubledqn_3 --plot_type avg_performance --figname image/exp2_1.png
