...
python cs285/scripts/read_results.py q2_dqn q2_cql --figname image/q2_1.png

## SubPart 2
python cs285/scripts/run_hw5_expl.py --env_name PointmassHard-v0 --use_rnd --num_exploration_steps 5000 --offline_exploitation --cql_alpha 0.1 --unsupervised_exploration --exp_name q2_cql_numsteps_5000
python cs285/scripts/run_hw5_expl.py --env_name PointmassHard-v0 --use_rnd --num_exploration_steps 15000 --offline_exploitation --cql_alpha 0.1 --unsupervised_exploration --exp_name q2_cql_numsteps_15000
python cs285/scripts/read_results.py q2_cql_numsteps_5000 q2_cql_numsteps_15000 --figname image/q2_2.png

python cs285/scripts/run_hw5_expl.py --env_name PointmassHard-v0 --use_rnd --num_exploration_steps 5000 --offline_exploitation --cql_alpha 0 --unsupervised_exploration --exp_name q2_dql_numsteps_5000
python cs285/scripts/run_hw5_expl.py --env_name PointmassHard-v0 --use_rnd --num_exploration_steps 15000 --offline_exploitation --cql_alpha 0 --unsupervised_exploration --exp_name q2_dql_numsteps_15000
