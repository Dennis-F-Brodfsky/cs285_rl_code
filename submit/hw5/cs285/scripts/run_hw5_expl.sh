...
python cs285/scripts/run_hw5_expl.py --env_name PointmassHard-v0 --use_rnd --num_exploration_steps 5000 --offline_exploitation --cql_alpha 0 --exploit_rew_shift 1 --exploit_rew_scale 25 --unsupervised_exploration --exp_name q2_dql_numsteps_5000
python cs285/scripts/run_hw5_expl.py --env_name PointmassHard-v0 --use_rnd --num_exploration_steps 15000 --offline_exploitation --cql_alpha 0 --exploit_rew_shift 1 --exploit_rew_scale 25 --unsupervised_exploration --exp_name q2_dql_numsteps_15000
