...
python cs285/scripts/read_results.py q1_cheetah_n500_arch1x32 q1_cheetah_n5_arch2x250 q1_cheetah_n500_arch2x250 --figname image/q1.png
...
python cs285/scripts/read_results.py q2_obstacles_singleiteration --figname image/q2.png
...
python cs285/scripts/read_results.py q3_obstacles q3_reacher q3_cheetah --figname image/q3.png
...
python cs285/scripts/read_results.py q5_cheetah_random q5_cheetah_cem_2 q5_cheetah_cem_4 --figname image/q4_4.png
