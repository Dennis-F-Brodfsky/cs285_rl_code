...
def main():
    ...
    PLOT_TYPE = {'error_bar': plot_error_bar, 'learning_curve': plot_learning_curve} 
    parser = argparse.ArgumentParser()
    parser.add_argument('exp_names', nargs='+', type=str)
    parser.add_argument('--plot_type', choices=['error_bar', 'learning_curve'], default='learning_curve')
